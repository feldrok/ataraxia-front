...
export default function FastBuy({ stock, name }) {
    ...
    return (
        <>
            <div
                className={`flex bg-slate-500 hover:bg-slate-400 duration-300 p-2 cursor-pointer rounded-sm`}
            >
                ...
                <button
                    ...
                    onClick={() =>
                        alert(`Comprarás rápidamente ${quantity} ${name}`)
                    }
                >
                    Compra rápida
                </button>
